...
const BRANCHES = [
  { id: "centro",   name: "Reha Centro",   short: "Centro",   addr: "Av. Carranza 1240, Col. Tequisquiapan",     phone: "+52 444 812 3340", color: "#3FBCD4", dot: "#3FBCD4", patients: 184, sessions: 122, occupancy: 86, salas: 4, fisios: 6, revenue: 198400, status: "Activa" },
  { id: "lomas",    name: "Reha Lomas",    short: "Lomas",    addr: "Av. Salvador Nava 3055, Lomas 4ª Sección",  phone: "+52 444 825 1170", color: "#5B8AC9", dot: "#5B8AC9", patients: 156, sessions: 104, occupancy: 78, salas: 3, fisios: 5, revenue: 162900, status: "Activa" },
  { id: "carranza", name: "Reha Carranza", short: "Carranza", addr: "Blvd. Río Españita 415, Lomas del Tecnológico", phone: "+52 444 199 4422", color: "#7EE3C5", dot: "#7EE3C5", patients: 147, sessions: 86,  occupancy: 71, salas: 3, fisios: 5, revenue: 126000, status: "Activa" },
];
...
const BRANCH_PERF = [
  { id: "centro",   name: "Reha Centro",   patients: 184, sessions: 122, occupancy: 86, revenue: 198400, nps: 76 },
  { id: "lomas",    name: "Reha Lomas",    patients: 156, sessions: 104, occupancy: 78, revenue: 162900, nps: 71 },
  { id: "carranza", name: "Reha Carranza", patients: 147, sessions:  86, occupancy: 71, revenue: 126000, nps: 69 },
];
...
const INTEGRATIONS = [
  { name: "WhatsApp Business",   desc: "Confirmaciones, recordatorios, notas SOAP", status: "Conectado",  by: "Reha · Centro",  color: "#34D399" },
...
const PACKAGES_CATALOG = [
  { id: "PKG-VAL", name: "Valoración inicial", desc: "Evaluación clínica + plan de tratamiento", sessions: 1, mins: 60, price: 1200, hot: false, color: "#3FBCD4", tag: "Esencial" },
  { id: "PKG-S1",  name: "Sesión individual",  desc: "Sesión de fisio 60 min — paga sobre la marcha", sessions: 1, mins: 60, price: 950, hot: false, color: "#5B8AC9", tag: "Flexible" },
  { id: "PKG-S5",  name: "Paquete 5 sesiones", desc: "Ahorra 8% — válido 60 días", sessions: 5, mins: 60, price: 4400, was: 4750, hot: false, color: "#7EE3C5", tag: "Recomendado" },
  { id: "PKG-S10", name: "Paquete 10 sesiones", desc: "Ahorra 15% — válido 90 días", sessions: 10, mins: 60, price: 8075, was: 9500, hot: true, color: "#3FBCD4", tag: "Más vendido" },
  { id: "PKG-LCA", name: "Programa LCA · 24 sesiones", desc: "Post-quirúrgico completo con readaptación", sessions: 24, mins: 75, price: 18900, was: 22800, hot: false, color: "#A78BFA", tag: "Programa" },
  { id: "PKG-PER", name: "Performance Pre-temporada", desc: "8 sesiones + 2 valoraciones + plan nutricional", sessions: 10, mins: 75, price: 14400, was: 16500, hot: false, color: "#F59E0B", tag: "Atletas" },
  { id: "PKG-MEM", name: "Membresía mensual", desc: "Sesiones ilimitadas + nutrición + chat 24/7", sessions: 999, mins: 60, price: 6500, was: null, hot: false, color: "#34D399", tag: "Suscripción" },
];

const MY_PACKAGES = [
  { id: "PKG-LCA", name: "Programa LCA · 24 sesiones", used: 14, total: 24, expires: "10 Ago 2026", status: "Activo", color: "#A78BFA" },
  { id: "PKG-NUT", name: "Plan nutricional · 12 sem.", used: 7,  total: 12, expires: "20 Jul 2026", status: "Activo", color: "#34D399" },
];

const PURCHASE_HISTORY = [
  { id: "PUR-2412", name: "Programa LCA · 24 sesiones", date: "10 Mar 2026", amount: 18900, method: "Tarjeta · ****0192", status: "Pagado" },
  { id: "PUR-2398", name: "Plan nutricional · 12 sem.", date: "10 Mar 2026", amount: 4800,  method: "Tarjeta · ****0192", status: "Pagado" },
  { id: "PUR-2387", name: "Valoración inicial",          date: "08 Mar 2026", amount: 1200,  method: "Tarjeta · ****0192", status: "Pagado" },
];

/* ─── Nutrición ────────────────────────────────────────────────────── */
const NUTRITION_TODAY = {
  calories: { goal: 2400, eaten: 1640 },
  macros: { protein: { g: 142, goal: 180 }, carbs: { g: 198, goal: 280 }, fats: { g: 58, goal: 78 } },
  water:  { ml: 1800, goal: 3000 },
};

const NUTRITION_MEALS = [
  { meal: "Desayuno",   time: "07:30", title: "Avena con frutos rojos y proteína",   kcal: 480, p: 38, c: 64, f: 12, status: "done",    icon: "🥣" },
  { meal: "Snack AM",   time: "10:30", title: "Yogurt griego + nueces",              kcal: 220, p: 18, c: 14, f: 11, status: "done",    icon: "🥜" },
  { meal: "Comida",     time: "14:00", title: "Pollo a la plancha, arroz integral, ensalada", kcal: 640, p: 52, c: 72, f: 18, status: "done", icon: "🍗" },
  { meal: "Pre-fisio",  time: "16:30", title: "Plátano + crema de cacahuate",        kcal: 300, p: 12, c: 42, f: 12, status: "done",    icon: "🍌" },
  { meal: "Cena",       time: "20:00", title: "Salmón al horno con quinoa y verdes", kcal: 520, p: 42, c: 38, f: 22, status: "pending", icon: "🐟" },
  { meal: "Post-cena",  time: "22:00", title: "Caseína + almendras",                  kcal: 240, p: 28, c: 12, f: 10, status: "pending", icon: "🥛" },
];

const NUTRITION_RECIPES = [
  { id: "RCP-01", title: "Bowl post-entreno",            time: 15, kcal: 540, p: 42, type: "Recuperación", thumb: "linear-gradient(135deg,#1B3A2A,#0E1F1A)", tag: "Post-fisio" },
  { id: "RCP-02", title: "Salmón al sartén con quinoa", time: 25, kcal: 520, p: 42, type: "Cena",         thumb: "linear-gradient(135deg,#3A2419,#1F140C)", tag: "Anti-inflamatorio" },
  { id: "RCP-03", title: "Smoothie verde colágeno",     time:  5, kcal: 280, p: 24, type: "Snack",        thumb: "linear-gradient(135deg,#1F3A2A,#0E1F18)", tag: "Tendones" },
  { id: "RCP-04", title: "Tazón de avena energizante",  time: 10, kcal: 480, p: 32, type: "Desayuno",     thumb: "linear-gradient(135deg,#3A2A14,#1F1A0C)", tag: "Pre-entreno" },
  { id: "RCP-05", title: "Pasta integral con pollo",    time: 20, kcal: 620, p: 48, type: "Comida",       thumb: "linear-gradient(135deg,#2A1A2A,#1A0F1A)", tag: "Carga" },
  { id: "RCP-06", title: "Curry de garbanzos",          time: 30, kcal: 460, p: 28, type: "Cena",         thumb: "linear-gradient(135deg,#3A2A0E,#1F180A)", tag: "Vegetariano" },
];

const SUPPLEMENTS = [
  { name: "Colágeno hidrolizado + Vit C", dose: "10 g",    when: "30 min antes de fisio", reason: "Síntesis de tendón post-quirúrgico" },
  { name: "Omega-3 EPA/DHA",              dose: "2 g",     when: "Con la comida",          reason: "Anti-inflamatorio crónico" },
  { name: "Creatina monohidrato",         dose: "5 g",     when: "Diario",                  reason: "Recuperación de fuerza" },
  { name: "Magnesio bisglicinato",        dose: "300 mg",  when: "Antes de dormir",        reason: "Sueño y reparación muscular" },
];

/* ─── Chat ─────────────────────────────────────────────────────────── */
const CHAT_MESSAGES = [
  { from: "fisio", text: "Hola Carlos, ¿cómo amaneciste de la rodilla?", time: "Ayer 09:12" },
  { from: "me",    text: "Mucho mejor, casi sin molestia al subir escaleras.", time: "Ayer 09:24" },
  { from: "fisio", text: "Excelente. Hoy quiero que hagas la rutina B con 3 series de step-up. Súbele 2kg al lastre.", time: "Ayer 09:25" },
  { from: "fisio", text: "Y mándame video del salto unipodal cuando lo hagas, para ver el control.", time: "Ayer 09:26", attached: "🎬 Video adjunto · 18s" },
  { from: "me",    text: "Va. Aquí está 👇", time: "Ayer 18:42", attached: "🎬 Video · 22s" },
  { from: "fisio", text: "Buen control. Pídeme reagendar el martes si necesitas más tiempo entre sesiones. Mañana descansa.", time: "Ayer 19:08" },
  { from: "me",    text: "Gracias doc, mañana mando dolor EVA al despertar.", time: "Hoy 07:14", read: true },
];

Object.assign(window, {
  PACKAGES_CATALOG, MY_PACKAGES, PURCHASE_HISTORY,
  NUTRITION_TODAY, NUTRITION_MEALS, NUTRITION_RECIPES, SUPPLEMENTS,
  CHAT_MESSAGES,
