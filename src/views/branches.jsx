    ...
    <div className="px-6 pt-5 pb-10">
      <div className="flex items-end justify-between mb-5">
        <div>
          ...
          <div className="text-[12px] font-mono mt-1" style={{ color: t.subtle }}>3 activas · 1 en planeación · Reha SLP</div>
        </div>
      ...
      <div className="grid grid-cols-3 gap-3 mb-6">
        ...
        <Card theme={theme} padding="p-0" className="overflow-hidden col-span-3" style={{ borderStyle: "dashed" }}>
          <div className="grid grid-cols-[1fr_auto] items-center px-5 py-4">
            <div>
              <div className="text-[12px] font-semibold tracking-tightish" style={{ color: t.text }}>Reha Querétaro · En planeación</div>
          ...
          <div className="px-4 py-3" style={{ borderRight: `1px solid ${t.border}` }}>
            ...
            <div className="space-y-2">
              {[
                ...
                { l: "Marca y branding",             v: "Tema Reha" },
